<?php
    ...
    if(isSecure()){
        ...
        $query = "INSERT INTO underpads(`confinement_id`,`tick`,`price`,`created_at`,`updated_at`)VALUES('$confinementId',1,30,'$todayDate','$todayDate')";
        $con->query($query) or die($con->error);

        $query = "SELECT * FROM underpads WHERE id = LAST_INSERT_ID()";
