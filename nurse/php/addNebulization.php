<?php
    ...
    if(isSecure()){
        ...
        $query = "INSERT INTO nebulizations(`confinement_id`,`tick`,`price`,`created_at`,`updated_at`)VALUES('$confinementId',1,250,'$todayDate','$todayDate')";
        $con->query($query) or die($con->error);

        $query = "SELECT * FROM nebulizations WHERE id = LAST_INSERT_ID()";
