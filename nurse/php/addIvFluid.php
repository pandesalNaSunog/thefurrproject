<?php
    ...
    if(isSecure()){
        ...
        $query = "INSERT INTO i_v_fluids(`confinement_id`,`tick`,`price`,`created_at`,`updated_at`)VALUES('$confinementId',1,200,'$todayDate','$todayDate')";
        $con->query($query) or die($con->error);

        $query = "SELECT * FROM i_v_fluids WHERE id = LAST_INSERT_ID()";
