<?php
    ...
    if(isSecure()){
        ...
        $query = "INSERT INTO food(`confinement_id`,`tick`,`price`,`created_at`,`updated_at`)VALUES('$confinementId',1,350,'$todayDate','$todayDate')";
        $con->query($query) or die($con->error);

        $query = "SELECT * FROM food WHERE id = LAST_INSERT_ID()";
